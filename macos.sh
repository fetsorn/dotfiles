...
defaults write NSGlobalDomain com.apple.sound.uiaudio.enabled 0
...
# set languages
defaults write NSGlobalDomain AppleLanguages -array "en" "zh" "ru"
defaults write NSGlobalDomain AppleLocale -string "en"
